  ...
  return (
    <div>
       <div className={style.card}>
            <a  href='https://github.com/LeanAlb' target='_blank' className={style.socialLink1}>
            ...
            <a href='https://www.linkedin.com/in/leandro-albrieu-192b03282/' target='_blank' className={style.socialLink2}>
